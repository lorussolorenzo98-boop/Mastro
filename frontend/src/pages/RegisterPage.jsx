  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Background foto solo su mobile */}
        {isMobile && (
          <>
            <img
        ...
        <div style={{
          ...
          <p style={{ fontSize: '14px', color: '#5a6b5a', marginBottom: '20px' }}>
            Hai già un account?{' '}
            <Link to="/login" style={{ color: '#1a2e1a', fontWeight: '500' }}>Accedi</Link>
          </p>

          {error && (
            <div style={{ background: '#FCEBEB', border: '0.5px solid #F09595', borderRadius: '8px', padding: '12px', fontSize: '14px', color: '#A32D2D', marginBottom: '16px' }}>
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{
              ...
              <div>
                ...
                <input name="firstname" value={formData.firstname} onChange={handleChange} required placeholder="Mario" style={inputStyle} />
              </div>
              <div>
                <label style={{ fontSize: '13px', color: '#5a6b5a', display: 'block', marginBottom: '5px' }}>Cognome</label>
                <input name="surname" value={formData.surname} onChange={handleChange} required placeholder="Rossi" style={inputStyle} />
              </div>
            </div>

            <div style={{ marginBottom: '14px' }}>
              <label style={{ fontSize: '13px', color: '#5a6b5a', display: 'block', marginBottom: '5px' }}>Email</label>
              <input name="email" type="email" value={formData.email} onChange={handleChange} required placeholder="la-tua@email.it" style={inputStyle} />
            </div>

            <div style={{ marginBottom: '14px' }}>
              <label style={{ fontSize: '13px', color: '#5a6b5a', display: 'block', marginBottom: '5px' }}>Password</label>
              <input name="password" type="password" value={formData.password} onChange={handleChange} required placeholder="••••••••" style={inputStyle} />
            </div>
